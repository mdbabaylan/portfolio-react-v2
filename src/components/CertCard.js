export default function CertCard(props){
    ...
    let markObject = {
        ...
        softSkills: ["Excellent Client/Stakeholder Communication", "Adaptability", "Accountability", 
                     "Leadership", "Self-reliance", "Collaboration and Teamwork"],
    
        techSkills: ["Vue.js", "Salesforce Apex and Visualforce Development", 
                     "HTML/CSS/JS", "Node.js", "Jira", 
                     "MySQL/Microsoft SQL", "React.js", "AWS S3/EB"],
    
        message: "Perpetual curiosity, learning and providing value"
    }
